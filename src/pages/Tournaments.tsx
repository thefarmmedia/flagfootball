            ...
            <div className="border border-gray-800 bg-gray-900 p-6 sm:p-8 lg:p-10 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <label className="block text-sm font-bold text-gray-300 text-center">Coach / Contact Name <span className="text-brand-red">*</span>
                    <input name="coachName" required value={form.coachName} onChange={handleChange} className="mt-2 w-full rounded border border-gray-700 bg-gray-800 px-4 py-3 text-white text-center outline-none focus:border-orange-400" placeholder="Coach name" />
                  </label>
                  <label className="block text-sm font-bold text-gray-300 text-center">Team Name <span className="text-brand-red">*</span>
                    <input name="teamName" required value={form.teamName} onChange={handleChange} className="mt-2 w-full rounded border border-gray-700 bg-gray-800 px-4 py-3 text-white text-center outline-none focus:border-orange-400" placeholder="Team / organization" />
                  </label>
                </div>

                <div className="grid sm:grid-cols-2 gap-5">
                  <label className="block text-sm font-bold text-gray-300 text-center">Email <span className="text-brand-red">*</span>
                    <input type="email" name="email" required value={form.email} onChange={handleChange} className="mt-2 w-full rounded border border-gray-700 bg-gray-800 px-4 py-3 text-white text-center outline-none focus:border-orange-400" placeholder="coach@example.com" />
                  </label>
                  <label className="block text-sm font-bold text-gray-300 text-center">Phone <span className="text-brand-red">*</span>
                    <input type="tel" name="phone" required value={form.phone} onChange={handleChange} className="mt-2 w-full rounded border border-gray-700 bg-gray-800 px-4 py-3 text-white text-center outline-none focus:border-orange-400" placeholder="(417) 555-0100" />
                  </label>
                </div>

                <div className="grid sm:grid-cols-2 gap-5">
                  <label className="block text-sm font-bold text-gray-300 text-center">Division / Program <span className="text-brand-red">*</span>
                    <select name="division" required value={form.division} onChange={handleChange} className="mt-2 w-full rounded border border-gray-700 bg-gray-800 px-4 py-3 text-white text-center outline-none focus:border-orange-400">
                  ...
                  <label className="block text-sm font-bold text-gray-300 text-center">City / State
                    <input name="cityState" value={form.cityState} onChange={handleChange} className="mt-2 w-full rounded border border-gray-700 bg-gray-800 px-4 py-3 text-white text-center outline-none focus:border-orange-400" placeholder="Springfield, MO" />
                  </label>
                </div>

                <label className="block text-sm font-bold text-gray-300 text-center">Age Group / Notes
                  <textarea name="notes" rows={4} value={form.notes} onChange={handleChange} className="mt-2 w-full rounded border border-gray-700 bg-gray-800 px-4 py-3 text-white text-center outline-none focus:border-orange-400 resize-none" placeholder="Age group, number of teams, questions, etc." />
                </label>

                {status === 'error' && (
                  <div className="flex items-center justify-center gap-2 border border-red-800/50 bg-red-950/40 p-4 text-red-300 text-sm text-center">
                    <AlertCircle size={18} className="shrink-0" /> We couldn't submit the form. Please try again or contact Missouri EPIC directly.
                  </div>
                )}
