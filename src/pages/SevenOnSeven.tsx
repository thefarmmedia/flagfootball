  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-brand-gold/10 via-gray-950 to-gray-950" />
        <div className="absolute top-0 left-1/2 w-[600px] h-[600px] bg-brand-gold/5 rounded-full blur-[120px] pointer-events-none -translate-x-1/2" />
